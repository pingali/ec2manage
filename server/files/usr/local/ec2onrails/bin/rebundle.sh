...
echo "--> Creating image..."
ec2-bundle-vol -r i386 -e "/root/.ssh,/home/app/.ssh,/tmp,/mnt,$EXTRA_EXCLUDE_DIRS" -d /mnt -k "$EC2_PRIVATE_KEY" -c "$EC2_CERT" -u "$AWS_ACCOUNT_ID" || fail "ec2-bundle-vol failed"
